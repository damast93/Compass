...
Module Intersections
    ...
    Public Function CirclePoint(a As Circle, p As Point) As Geometry
    ...
    Public Function PointPoint(a As Point, b As Point) As Geometry
    ...
    Public Function CircleCircle(a As Circle, b As Circle) As Geometry
    ...
    Public Function CircleLine(c As Circle, line As Line) As Geometry
        ' Shift to origin
    ...
    Public Function PointLine(p As Point, line As Line) As Geometry
    ...
    Public Function LineLine(a As Line, b As Line) As Geometry
        Dim nx = -a.dy, ny = a.dx
