Public Class Line
    ...
    Public Overrides Function Intersect(other As Geometry) As Geometry
        If TypeOf other Is Circle Then
            Return Filter(Intersections.CircleLine(DirectCast(other, Circle), Me))
        ElseIf TypeOf other Is Point Then
            Return Filter(Intersections.PointLine(DirectCast(other, Point), Me))
        ElseIf TypeOf other Is Line Then
            Dim otherRay = DirectCast(other, Line)
            Return otherRay.Filter(Filter(Intersections.LineLine(DirectCast(other, Line), Me)))
